/*****************************************************************************
* 
* Nagios check_cpu plugin by liberodark & Laurent Levasseur
* Fork of Nagios check_load plugin
* 
* License: GPL
...
* Description:
* 
* This file contains the check_cpu plugin
* 
...
const char *progname = "check_cpu";
const char *copyright = "1999-2019";
const char *email = "liberodark@gmail.com";
